...
Feature: Non stackable promo and stackable promo combinations allowed on billing & review page
  ...
  #id 218, 219
  Scenario: Non stackable promo and stackable promo combinations allowed on review page
    When User navigates to regular product
    Then Verify product detail page is displayed
