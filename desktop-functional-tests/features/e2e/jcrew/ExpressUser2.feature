@e2e @e2e-expressuser-2
Feature: Express User 2 E2E order placing

 Scenario: Express User 2 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_ExpressUser_Testdata_Sheet_2.xls"	
