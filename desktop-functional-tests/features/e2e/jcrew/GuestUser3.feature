@e2e @e2e-guestuser-3
Feature: Guest User 3 E2E order placing

 Scenario: Guest User 3 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_3.xls"	
