@e2e @e2e-guestuser-2
Feature: Guest User 2 E2E order placing

 Scenario: Guest User 2 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_2.xls"	
