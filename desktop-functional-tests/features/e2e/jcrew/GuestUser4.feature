@e2e @e2e-guestuser-4
Feature: Guest User 4 E2E order placing

 Scenario: Guest User 4 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_4.xls"	
