@e2e @e2e-guestuser-5
Feature: Guest User 5 E2E order placing

 Scenario: Guest User 5 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_5.xls"	
