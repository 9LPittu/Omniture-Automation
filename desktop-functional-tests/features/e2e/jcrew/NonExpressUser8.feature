@e2e @e2e-nonexpressuser-8
Feature: Non Express User 8 E2E order placing

 Scenario: Non Express User 8 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_NonExpressUser_Testdata_Sheet_8.xls"	
