@e2e @e2e-guestuser-8
Feature: Guest User 8 E2E order placing

 Scenario: Guest User 8 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_8.xls"	
