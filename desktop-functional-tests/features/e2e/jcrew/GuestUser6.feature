@e2e @e2e-guestuser-6
Feature: Guest User 6 E2E order placing

 Scenario: Guest User 6 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_6.xls"	
