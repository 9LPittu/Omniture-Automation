@e2e @e2e-guestuser-9
Feature: Guest User 9 E2E order placing

 Scenario: Guest User 9 order placing E2E scenario
	Given Test data is read from excel file "JC_E2E_GuestUser_Testdata_Sheet_9.xls"	
