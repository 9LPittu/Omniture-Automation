...
Feature: Header and Footer - Let us help you section
  ...
  Scenario: Verify footer links displayed under About J.Crew section are functional from home page
  ...
  Scenario: Verify footer links displayed under our stores and brands section are functional from home page
  ...
  Scenario: Verify footer links displayed under jcrew credit card are functional from home page
