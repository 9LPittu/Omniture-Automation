...
Feature: Footer From Gender landing page
  ...
  Scenario: Verify Our Brands links in footer are functional from Gender landing page
  ...
  Scenario: Verify popular search links in footer are functional from Gender landing page
