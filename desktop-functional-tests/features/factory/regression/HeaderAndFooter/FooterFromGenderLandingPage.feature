@Footer3
Feature: Footer From Gender landing page - Let Us Help You and About Factory
  ...
  Scenario: Verify Let Us Help You links in footer are functional from Gender landing page
  ...
  Scenario: Verify About Factory links in footer are functional from Gender landing page
