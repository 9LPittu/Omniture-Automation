...
public class CheckoutSignInSteps extends DriverFactory {
    ...
    public void sign_in_and_check_out() {
    	if(signIn.stateHolder.hasKey("sidecarusername")){
    		String emailAddress = (String) signIn.stateHolder.get("sidecarusername");
    		String password = (String) signIn.stateHolder.get("sidecaruserpassword");    		
    		signIn.enterLoginCredentials(emailAddress, password);
    	}
    	else{
