...
public class CheckoutShippingOptions extends Checkout {
	...
	public ShippingMethod getSelectedShippingMethod() {
		WebElement selectedLabel = shippingMethodForm
				.findElement(By.xpath(".//label[@class='form-label radio-checked']"));
		WebElement selectedMethod = selectedLabel
				.findElement(By.xpath(".//ancestor::div[contains(@class,'form-shipmethod')]"));
	...
	public String getSelectedShippingMethodName() {
		...
		WebElement selectedLabel = shippingMethodForm
				.findElement(By.xpath(".//label[@class='form-label radio-checked']"));
		WebElement shipMethodName = selectedLabel
				.findElement(By.xpath(".//span[@class='method-group']/span[contains(@class,'label')]"));
	...
	public void selectShippingMethod() {
		List<WebElement> methods = shippingMethodForm
				.findElements(By.xpath(".//div[contains(@class, 'form-shipmethod') and contains(@id, 'method')]"));
	...
	public void selectSpecificShippingMethod(String shippingMethodName) {
		try {
			WebElement shippingMethodRadioBtn = shippingMethodContainer
					.findElement(By.xpath(".//span[@class='method-group' and contains(normalize-space(.),'"
							+ shippingMethodName + "')]/preceding-sibling::input[@name='shippingMethod']"));
	...
	public void selectSpecificShippingMethodInReviewPage(String shippingMethodName) {
		try {
			WebElement shippingMethodRadioBtn = shippingDetails.findElement(
					By.xpath("//span[@class='method-group']/span[contains(text(),'" + shippingMethodName + "')]"));
			shippingMethodRadioBtn.click();
			logger.debug("Selected Shipping Method: {}", shippingMethodName);
		} catch (NoSuchElementException nsee) {
			String errorMsg = "Failed to identify/select the shipping method '" + shippingMethodName + "'";
	...
	public void selectSpecificShippingMethod(WebElement shippingMethodSection, String shippingMethodName) {
		...
		try {
			WebElement shippingMethodRadioBtn = shippingMethodSection
					.findElement(By.xpath(".//span[@class='method-group' and contains(normalize-space(.),'"
							+ shippingMethodName + "')]/preceding-sibling::input[contains(@name, 'shippingMethod')]"));
			shippingMethodRadioBtn.click();
			logger.debug("Selected Shipping Method: {}", shippingMethodName);
		} catch (NoSuchElementException nsee) {
			String errorMsg = "Failed to identify/select the shipping method '" + shippingMethodName + "'";
	...
	public void selectSpecificShippingMethodInReviewPage(WebElement shippingMethodSection, String shippingMethodName) {

		try {
			WebElement shippingMethodRadioBtn = shippingMethodSection.findElement(
							By.xpath("//span[@class='method-group']/span[contains(text(),'" + shippingMethodName + "')]"));
			shippingMethodRadioBtn.click();
			logger.debug("Selected Shipping Method: {}", shippingMethodName);
		} catch (NoSuchElementException nsee) {
	...
	public void selectMultipleShippingMethodsInReviewPage(String[] arrShippingMethods) {
		List<WebElement> shippingMethodSections = shippingDetails.findElements(By.className("form-section-address"));
		for (int i = 0; i < arrShippingMethods.length; i++) {
			selectSpecificShippingMethodInReviewPage(shippingMethodSections.get(i), arrShippingMethods[i]);
		}
	}


	public void selectGiftOptionRadioButtons() {
		List<WebElement> giftOptionRadioElements = shippingMethodContainer
				.findElements(By.xpath(".//input[contains(@id, 'includesGifts')]"));
	...
	public void enterGiftReceiptMessages() {
		List<WebElement> giftReceiptMessageElements = shippingMethodContainer
				.findElements(By.xpath(".//textarea[contains(@id,'gift-receipt-msg')]"));
