...
public class Reporter {
    ...
    /**
     * To set automation reports related config
     *
     * @param reportFolderName
     */
    public static void setReportsConfig(String reportFolderName) {
        ExtentProperties extentProperties = ExtentProperties.INSTANCE;
        Calendar cal = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat("MM-dd-yyyy_HH-mm-ss");
        String time = sdf.format(cal.getTime());
        String path = System.getProperty("user.dir") + File.separator + "Reports" + File.separator + reportFolderName + "_" + time;
