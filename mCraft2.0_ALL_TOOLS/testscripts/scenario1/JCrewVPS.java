...
public class JCrewVPS extends TestCase
{
	...
	public void executeTest()
	{
		...
		//PDP Page Elements - Size, Out of Stock Items
		this.sleep(4);
		JCrewProductDetailPage jcrewPDP = new JCrewProductDetailPage(webdriver);
		if(jcrewPDP.getVPSMessageString().length() > 0 )
			
			report.updateTestCaseLog(" Verified", "VPS Message is " +  jcrewPDP.getVPSMessageString().substring(0,145) ,Status.PASS); 
