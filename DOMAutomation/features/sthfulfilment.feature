...
Feature: Test DOM-STH fulfilment

  Scenario: Test DOM STH fulfilment flow
    Given Test data is read from excel file "JC_DOM_Orderfulfilment_STH.xls"
    ...
    And I enter order number "JC_DOM_Orderfulfilment_STH.xls"
