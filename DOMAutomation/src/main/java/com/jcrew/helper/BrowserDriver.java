...
public class BrowserDriver {
    ...
    public static void reopenAndLoadPage(String url) throws InterruptedException {
        mDriver = null;
        getCurrentDriver();
        loadPage(url);
    }
    ...
    public static void waitForElementToVisible(WebElement elementToWaitFor, Integer waitTimeInSeconds) {
        WebDriverWait wait = new WebDriverWait(getCurrentDriver(), waitTimeInSeconds);
    ...
    public static void waitForElementToEnabled(WebElement elementToWaitFor, Integer waitTimeInSeconds) {
        for(int i=1; i<=waitTimeInSeconds; i++){
    ...
    public static void waitForPageToBestable() {
