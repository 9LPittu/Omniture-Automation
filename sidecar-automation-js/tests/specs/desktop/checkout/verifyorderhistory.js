...
beforeAll(async () => {
  ...
  test('Express User Checkout', async () => {
    ...
    //  await driver.sleep(3000)
      ...
      await driver.findElement(By.xpath("//*[@id='loginUser']")).sendKeys(logindetails.username4)
      await driver.findElement(By.xpath("//*[@id='loginPassword']")).sendKeys(logindetails.password4)
      await driver.sleep(2000)
