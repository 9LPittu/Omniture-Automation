...
test('title is correct', async () => {
  ...
  test('verify egc functionality', async () => {
    driver.sleep(2000);
  ...
  //  await driver.findElement(By.css("#eGiftCard")).click()
    await driver.executeScript("arguments[0].click();",driver.findElement(By.css("#eGiftCard")));
    await driver.sleep(3000)
    await driver.executeScript("arguments[0].click();",driver.findElement(By.css("#amount25")));
  //  await driver.findElement(By.css("#amount100")).click()
      await driver.sleep(3000)
      ...
      await driver.executeScript("arguments[0].click();",driver.findElement(By.css("#js-header__cart")));
      await driver.sleep(3000)
      //await driver.findElement(By.xpath("//*[@id='button-checkout']")).click()
      await driver.executeScript("arguments[0].click();",driver.findElement(By.css("#button-checkout")));
