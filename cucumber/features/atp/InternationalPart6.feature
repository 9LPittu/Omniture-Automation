@ATPInternational6
Feature: ATP should not display for international backorder and regular items - Hong Kong
  ...
  Background: Clean bag for user
   ...
   Scenario:  ATP should not display for backorder and regular items in international context
     #ATP_33
