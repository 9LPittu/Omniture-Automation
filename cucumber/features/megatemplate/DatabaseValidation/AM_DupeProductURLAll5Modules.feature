...
Scenario:  Verify if there is any duplication in product URLs across 5 modules CW,PA, NA, TR and BR
	When user executes feed validation AMDupfor5ModuleQuery sql in DB
	And user verify feed validation and log the results for the query AMDupfor5ModuleQuery
